...
export type IconName =
  ...
  | 'check' | 'search' | 'x' | 'alia-down' | 'alia-up'
  | 'plus' | 'grip' | 'link' | 'ig' | 'tt'
  | 'restart' | 'arrow' | 'copy' | 'share' | 'chat' | 'camera' | 'roll' | 'video';
...
const GLYPHS: Record<IconName, Glyph> = {
  ...
  roll: (s) => (
    <svg data-icon="roll" width={s} height={s} viewBox="0 0 24 24" fill="none">
      <path d="M4.5 15.5 V5 A1.5 1.5 0 0 1 6 3.5 H15" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" />
      <rect x="8" y="7" width="11.5" height="13" rx="1.5" stroke="currentColor" strokeWidth="1.4" />
      <rect x="10.1" y="9.3" width="7.3" height="5.8" stroke="currentColor" strokeWidth="1.2" />
    </svg>
  ),
  mic: (s) => (
  ...
  'alia-up': (s) => (
    <svg data-icon="alia-up" width={s} height={s} viewBox="0 0 24 24" fill="none">
      <path d="M4.5 20 L12 4 L19.5 20" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  ),
  plus: (s) => (
  ...
  video: (s) => (
    <svg data-icon="video" width={s} height={s} viewBox="0 0 24 24" fill="none">
      <rect x="3.5" y="6.5" width="12" height="11" rx="2" stroke="currentColor" strokeWidth="1.4" />
      <path d="M15.5 10.5 L20.5 7.5 V16.5 L15.5 13.5 Z" stroke="currentColor" strokeWidth="1.4" strokeLinejoin="round" />
    </svg>
  ),
};
