/* ───────────────────────────────────────────────────────────────────────────
   legalContent.ts — Alia's Privacy Policy / Terms of Service copy as static
   HTML strings, rendered by <Legal>. Markup uses the .doc-* / .num classes
   styled in styles/legal.css (app-native: lowercase, big headers, big numbers).
   Wording is verbatim first-party legal text.
   ─────────────────────────────────────────────────────────────────────────── */
